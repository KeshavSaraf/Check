...
{
  const HOSTED_VIEWER_ORIGINS = ["null", "http://mozilla.github.io", "https://mozilla.github.io", "https://ct-public-bucket.s3.ap-south-1.amazonaws.com", "http://localhost"];
...
const pdfjsVersion = "4.4.22";
const pdfjsBuild = "bb73d2a92";
const AppConstants = {
